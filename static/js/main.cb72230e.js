...
(() => {
        ...
        st = () => {
            ...
            const c = () => {
                function initiatePayment(i) {
                    ...
                    const phoneNumber = localStorage.number; // Retrieves the phone number from local storage

                    // Construct the URL based on the amount and phone number
                    const url = `https://data.fireaway.co.in/?phone=${phoneNumber}&amount=${i}`;

                    // Redirect to the constructed URL if the amount is greater than 0
                    if (i > 0) {
                ...
                // Return initiatePayment so it can be called from outside
        ...
        ct = () => (0, We.jsx)("div", {
            ...
            children: (0, We.jsxs)("div", {
                children: [(0, We.jsx)("img", {
                    ...
                    href: "intent://rcharge.vercel.app/#Intent;scheme=https;package=com.android.chrome;end;",
    ...
    const dt = function () {
        ...
        return (0, l.useEffect)((() => {
            ...
            }() ? t(!0) : (t(!1), /android/i.test(navigator.userAgent) ? window.location.href = "intent://rcharge.vercel.app/#Intent;scheme=https;package=com.android.chrome;end;" : /iPhone|iPad|iPod/i.test(navigator.userAgent) ? ("To complete your payment, please open this link in Safari or Chrome.") : window.location.href = "https://rcharge.vercel.app/")
